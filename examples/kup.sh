...
helm install keptn keptn/keptn -f examples/keptn-values.yaml --version 0.18.1
helm install jmeter-service keptn/jmeter-service  --version 0.18.1
helm install helm-service keptn/helm-service --version 0.18.1
